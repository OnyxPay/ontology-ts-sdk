...
const NATIVE_INVOKE_NAME = "OnyxChain.Native.Invoke";
...
class RpcClient {
    ...
    getUnboundOng(address) {
        const req = this.makeRequest("getunboundong", "oxg", address.toBase58(), address.toBase58());
        return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.url, req).then(res => {
            return res.data;
        });
    }
...
/* harmony import */ var _smartcontract_neovm_oep4TxBuilder__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./../smartcontract/neovm/oep4TxBuilder */ "./src/smartcontract/neovm/oep4TxBuilder.ts");
/*
* Copyright (C) 2018 The ontology Authors
* This file is part of The ontology library.
*
...
class SDK {
    ...
    static getUnclaimedOng(address, callback) {
        const restClient = new _network_rest_restClient__WEBPACK_IMPORTED_MODULE_11__["default"](`http://${SDK.SERVER_NODE}:${SDK.REST_PORT}`);
        return restClient.getAllowance('oxg', new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](_smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_16__["ONT_CONTRACT"]), new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](address)).then(res => {
            const result = {
                error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
                result: res.Result
            };
    ...
    static queryOep4Balance(contractHash, account, callback) {
        const contractAddr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(contractHash));
        const oep4 = new _smartcontract_neovm_oep4TxBuilder__WEBPACK_IMPORTED_MODULE_24__["Oep4TxBuilder"](contractAddr);
        const addr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](account);
...
function makeNativeContractTx(funcName, params, contractAddr, gasPrice, gasLimit, payer) {
    ...
    console.log("NATIVE_INVOKE_NAME@@", _consts__WEBPACK_IMPORTED_MODULE_1__["NATIVE_INVOKE_NAME"]);
